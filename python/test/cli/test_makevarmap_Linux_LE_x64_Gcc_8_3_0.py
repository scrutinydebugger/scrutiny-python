...
class TestMakeVarMap_LinuxLEx64_Gcc8_3_0(unittest.TestCase):
    ...
    def test_namespace(self):
        ...
        self.assert_var('/static/file1.cpp/NamespaceInFile1/NamespaceInFile1Nested1/file1StaticNestedVar1', VariableType.uint64, value_at_loc = 945612345)
    ...
    def test_structB(self):
        ...
        self.assert_var('/global/file1StructBInstance/structBMemberStructA/structAMemberUInt', VariableType.uint32,    addr=v.get_address() + 8,   value_at_loc =  33333)
        self.assert_var('/global/file1StructBInstance/structBMemberStructA/structAMemberFloat', VariableType.float32,  addr=v.get_address() + 12,  value_at_loc =  33.33)
        self.assert_var('/global/file1StructBInstance/structBMemberStructA/structAMemberDouble', VariableType.float64, addr=v.get_address() + 16,  value_at_loc =  22.22)
        self.assert_var('/global/file1StructBInstance/structBMemberStructA/structAMemberBool', VariableType.boolean,   addr=v.get_address() + 24,  value_at_loc =  True )
    ...
    def test_structC(self):
        ...
        self.assert_var('/global/file1StructCInstance/nestedStructInstance/nestedStructMemberInt', VariableType.sint32,    addr=v.get_address() + 4,   value_at_loc = 2298744 )
        self.assert_var('/global/file1StructCInstance/nestedStructInstance/nestedStructMemberFloat', VariableType.float32, addr=v.get_address() + 8,   value_at_loc = -147.55 )
        self.assert_var('/global/file1StructCInstance/nestedStructInstance/nestedStructInstance2/nestedStructInstance2MemberDouble', VariableType.float64, addr=v.get_address() + 12,   value_at_loc = 654.654)
    ...
    def test_structD(self):
        ...
        self.assert_var('/global/file1StructDInstance/bitfieldB', VariableType.uint32,     bitoffset=4,    bitsize=13, value_at_loc = 4100,    addr = v.get_address())
        self.assert_var('/global/file1StructDInstance/bitfieldC', VariableType.uint32,     bitoffset=13+4, bitsize=8,  value_at_loc = 222,     addr = v.get_address())
        self.assert_var('/global/file1StructDInstance/bitfieldD', VariableType.uint32,                                 value_at_loc = 1234567, addr = v.get_address() + 4)
        self.assert_var('/global/file1StructDInstance/bitfieldE', VariableType.uint32,     bitoffset=0,    bitsize=10, value_at_loc = 777,     addr = v.get_address() + 8)
