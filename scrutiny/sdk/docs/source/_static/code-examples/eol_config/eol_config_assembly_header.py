...
with client.connect(hostname, port, wait_status=True):    # Establish a connection and wait for a first server status update
    ...
    # Maps to /var/global/eeprom_configurator/m_last_return_code
    eeprom_config_return_code = client.watch('/alias/eeprom_configurator/return_code')

    # Maps to /var/global/eeprom_configurator/m_assembly_header/model
    assembly_header_model = client.watch('/alias/eeprom_configurator/assembly_header/model')
    # Maps to /var/global/eeprom_configurator/m_assembly_header/version
    assembly_header_version = client.watch('/alias/eeprom_configurator/assembly_header/version')
    # Maps to /var/global/eeprom_configurator/m_assembly_header/revision
    assembly_header_revision = client.watch('/alias/eeprom_configurator/assembly_header/revision')
    # Maps to /var/global/eeprom_configurator/m_assembly_header/serial
    assembly_header_serial = client.watch('/alias/eeprom_configurator/assembly_header/serial')
