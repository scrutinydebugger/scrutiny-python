...
class WriteRequest:
    ...
    def wait_for_completion(self, timeout: float = 5) -> None:
        ...
        :raise sdk.exceptions.TimeoutException: If the request does not complete within the allowed time
        :raise sdk.exceptions.OperationFailure: If the request complete with a failure state
        """
