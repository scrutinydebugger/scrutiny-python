...
DataloggerStateChangedCallback = Callable[[Optional[device_datalogging.DataloggerState], Optional[float]], None]
...
class DeviceHandler:
    ...
    # Calback called when the datalogger changes state (including completion ratio)
    datalogger_state_changed_callbacks: List[DataloggerStateChangedCallback]
    ...
    def register_datalogger_state_change_callback(self, callback: DataloggerStateChangedCallback) -> None:
        ...
        self.datalogger_state_changed_callbacks.append(callback)
    ...
    def process(self) -> None:
        ...
        if new_status != previous_status:
            for callback1 in self.device_state_changed_callbacks:
                callback1(new_status)
