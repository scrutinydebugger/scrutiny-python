...
class CDockAreaWidget(QFrame):
    ...
    def features(self, Mode:ads.eBitwiseOperator = ads.eBitwiseOperator.BitwiseAnd) -> CDockWidget.DockWidgetFeature: ...
...
class CDockContainerWidget(QFrame):  
    ...
    def addDockWidget(self, area:ads.DockWidgetArea, Dockwidget:CDockWidget, DockAreaWidget:Optional[CDockAreaWidget]=None, Index:int=-1)-> CDockAreaWidget: ...
    ...
    def sideTabBar(self, area:ads.SideBarLocation) -> CAutoHideSideBar: ...
...
class CDockManager(CDockContainerWidget):
    ...
    def addDockWidget(self, area:ads.DockWidgetArea, Dockwidget:CDockWidget, DockAreaWidget:Optional[CDockAreaWidget] = None, Index:int = -1) -> CDockAreaWidget: ...
    def addDockWidgetToContainer(self, area:ads.DockWidgetArea, Dockwidget:CDockWidget, DockContainerWidget:CDockContainerWidget) -> CDockAreaWidget: ...
    def addAutoHideDockWidget(self, Location:ads.SideBarLocation, Dockwidget:CDockWidget) -> CAutoHideDockContainer: ...
    def addAutoHideDockWidgetToContainer(self, Location:ads.SideBarLocation, Dockwidget:CDockWidget, DockContainerWidget:CDockContainerWidget) -> CAutoHideDockContainer: ...
    def addDockWidgetTab(self, area:ads.DockWidgetArea, Dockwidget:CDockWidget) -> CDockAreaWidget: ...
