...
#       self.assert_var('/global/task_100hz_loop_handler/m_loop2main_msg/data/data/datalogger_status_update/write_counter_since_trigger', EmbeddedDataType.uint32)
        ...
        self.assert_var('/global/task_1hz_loop_handler/m_timestep_100ns', EmbeddedDataType.uint32)
        self.assert_var('/global/task_1hz_loop_handler/m_timebase/m_time_100ns', EmbeddedDataType.uint32)
        self.assert_var('/global/task_1hz_loop_handler/m_main2loop_msg/m_written', EmbeddedDataType.boolean)
        self.assert_var('/global/task_1hz_loop_handler/m_main2loop_msg/data/message_id', EmbeddedDataType.uint8, enum='Main2LoopMessageID')
        self.assert_var('/global/task_1hz_loop_handler/m_loop2main_msg/m_written', EmbeddedDataType.boolean)
        self.assert_var('/global/task_1hz_loop_handler/m_loop2main_msg/data/message_id', EmbeddedDataType.uint8, enum='Loop2MainMessageID')
        # union not supported yet
#       self.assert_var('/global/task_1hz_loop_handler/m_loop2main_msg/data/data/datalogger_status_update/state', EmbeddedDataType.uint8, enum='DataloggerState')
#       self.assert_var('/global/task_1hz_loop_handler/m_loop2main_msg/data/data/datalogger_status_update/bytes_to_acquire_from_trigger_to_completion', EmbeddedDataType.uint32)
#       self.assert_var('/global/task_1hz_loop_handler/m_loop2main_msg/data/data/datalogger_status_update/write_counter_since_trigger', EmbeddedDataType.uint32)

        self.assert_var('/global/task_1hz_loop_handler/m_owns_datalogger', EmbeddedDataType.boolean)
        self.assert_var('/global/task_1hz_loop_handler/m_datalogger_data_acquired', EmbeddedDataType.boolean)
        self.assert_var('/global/task_1hz_loop_handler/m_support_datalogging', EmbeddedDataType.boolean)
    ...
    def test_main_handler(self):
        ...
        self.assert_var("/static/scrutiny_integration.cpp/config/m_datalogger_buffer_size", EmbeddedDataType.uint32)
        ...
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_config/m_datalogger_buffer_size", EmbeddedDataType.uint32)
        ...
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_datalogging/datalogger/m_buffer_size", EmbeddedDataType.uint32)
        ...
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_datalogging/datalogger/m_trigger_cursor_location", EmbeddedDataType.uint32)
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_datalogging/datalogger/m_remaining_data_to_write", EmbeddedDataType.uint32)
        ...
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_datalogging/datalogger/m_encoder/m_buffer_size", EmbeddedDataType.uint32)
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_datalogging/datalogger/m_encoder/m_reader/m_read_cursor", EmbeddedDataType.uint32)
        ...
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_datalogging/datalogger/m_encoder/m_max_entries", EmbeddedDataType.uint32)
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_datalogging/datalogger/m_encoder/m_next_entry_write_index", EmbeddedDataType.uint32)
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_datalogging/datalogger/m_encoder/m_first_valid_entry_index", EmbeddedDataType.uint32)
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_datalogging/datalogger/m_encoder/m_entry_write_counter", EmbeddedDataType.uint32)
        ...
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_datalogging/datalogger/m_encoder/m_entries_count", EmbeddedDataType.uint32)
        ...
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_datalogging/datalogger/m_log_points_after_trigger", EmbeddedDataType.uint32)
        ...
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_datalogging/threadsafe_data/bytes_to_acquire_from_trigger_to_completion", EmbeddedDataType.uint32)
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_datalogging/threadsafe_data/write_counter_since_trigger", EmbeddedDataType.uint32)
