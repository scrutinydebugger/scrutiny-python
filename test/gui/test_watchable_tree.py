...
class TestWatchTreeModel(BaseWatchableTreeTest):
    ...
    def test_refuse_bad_drag_data(self):
        ...
        mime_data_nodes_tied_to_registry = ScrutinyDragData(
            ScrutinyDragData.DataType.WatchableTreeNodesTiedToRegistry, data_copy=[], data_move=valid_data_move).to_mime()
